...
public class EmpleadoController {
	...
	public ResponseEntity<?> empleado(
		...
		if(empleado.validarCamposNull(nombre, apellido, tipodedocumento, numerodedocumento, fechadenacimiento, fechadevinculacion, cargo, salario) == true) {
		...
		try {
			...
			response.put("Error", "Los campos: fecha de nacimiento y fecha de vinculación, deben tener el formato dd-mm-aaaa");
			return new ResponseEntity<Map<String, Object>>(response, HttpStatus.BAD_REQUEST);
		}
