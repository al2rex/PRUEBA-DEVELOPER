...
public class EmpleadoImpl implements IEmpleado{
	...
	public Boolean validarCamposNull(String nombre, String apellido, String tipodedocumento, String numerodedocumento,
		...
		if(nombre.isEmpty() || apellido.isEmpty() || tipodedocumento.isEmpty() || numerodedocumento.isEmpty() || fechadenacimiento.isEmpty() ||  fechadevinculacion.isEmpty() || cargo.isEmpty()) {
			return true;
		}
